...
@Repository
public class PlacardImageRepository {
    ...
    public class PlacardImageRowMapper implements RowMapper<PlacardImage> {

        @Override
        public PlacardImage mapRow(ResultSet rs, int i) throws SQLException {
        ...
        private void setPlacardName(PlacardImage placardImage, ResultSet rs) {
            try {
        ...
        private void setPlacardImage(PlacardImage placardImage, ResultSet rs) throws SQLException {
